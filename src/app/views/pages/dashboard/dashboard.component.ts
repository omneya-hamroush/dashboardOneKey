...
export class DashboardComponent implements OnInit {
	...
	constructor(private loginService: LoginService ,private layoutConfigService: LayoutConfigService, private router: Router, private activatedRoute: ActivatedRoute) {
	}
